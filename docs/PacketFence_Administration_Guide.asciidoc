...
pfdhcplistener will parse the DHCP Option 82 and will use the map to resolve the MAC to the switch and will update the entry of the device in DHCP Option 82 audit.
